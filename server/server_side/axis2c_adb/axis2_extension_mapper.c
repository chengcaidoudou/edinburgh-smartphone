            ...
            axiom_node_t** node)
        {
            ...
            if (NULL == parent)
            {
                ...
                return (axis2_char_t*)AXIS2_FAILURE;
            }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SymbolSet") == 0)
                {
                    ...
                    (adb_SymbolSet_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_OptimizePortfolioSSDReturn") == 0)
                {
                    return adb_OptimizePortfolioSSDReturn_deserialize_obj(
                    (adb_OptimizePortfolioSSDReturn_t*) _object, env, dp_parent, dp_is_early_node_valid, dont_care_minoccurs);
                }
            ...
            axis2_char_t *default_type)
        {
            if (_object != NULL && adb_type_get_type(_object) != NULL)
            {
                ...
                if (axutil_strcmp(adb_type_get_type(_object), "adb_SymbolSet") == 0)
                {
                    ...
                    (adb_SymbolSet_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
            
                if (axutil_strcmp(adb_type_get_type(_object), "adb_OptimizePortfolioSSDReturn") == 0)
                {
                    return adb_OptimizePortfolioSSDReturn_serialize_obj(
                    (adb_OptimizePortfolioSSDReturn_t*) _object, env, om_node, om_element, tag_closed, namespaces, next_ns_index);
                }
